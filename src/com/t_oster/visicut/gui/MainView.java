...
public class MainView extends javax.swing.JFrame
{
  ...
  private void initComponents()
  {
    ...
    jScrollPane1.setMinimumSize(new java.awt.Dimension(400, 7));
    jScrollPane1.setName("jScrollPane1"); // NOI18N

    jPanel1.setMinimumSize(new java.awt.Dimension(0, 0));
    jPanel1.setName("jPanel1"); // NOI18N
    jPanel1.setPreferredSize(new java.awt.Dimension(300, 955));
    ...
    jPanel1.add(materialComboBox, gridBagConstraints);
    ...
    gridBagConstraints.gridwidth = 3;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
    gridBagConstraints.insets = new java.awt.Insets(3, 2, 4, 2);
    ...
    jPanel1.add(laserCutterComboBox, gridBagConstraints);
    ...
    jPanel1.add(calculateTimeButton, gridBagConstraints);
    ...
    mappingPanel.setPreferredSize(new java.awt.Dimension(300, 554));
    ...
    mappingTabbedPane.addTab("Position", positionPanel);
    ...
    jPanel1.add(mappingTabbedPane, gridBagConstraints);
    java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("com/t_oster/visicut/gui/resources/MainView"); // NOI18N
    mappingTabbedPane.getAccessibleContext().setAccessibleName(bundle.getString("MAPPING")); // NOI18N
    ...
    gridBagConstraints.gridy = 4;
    jPanel1.add(btAddMaterial, gridBagConstraints);
    ...
    gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
    gridBagConstraints.insets = new java.awt.Insets(0, 0, 10, 5);
    jPanel1.add(cbMaterialThickness, gridBagConstraints);
    ...
    gridBagConstraints.gridx = 2;
    gridBagConstraints.gridy = 7;
    jPanel1.add(btAddMaterialThickness, gridBagConstraints);
    ...
    gridBagConstraints.gridwidth = 3;
    gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
    jPanel1.add(executeJobButton, gridBagConstraints);
    ...
    jPanel1.add(objectComboBox, gridBagConstraints);
    ...
    java.util.ResourceBundle bundle1 = java.util.ResourceBundle.getBundle("com/t_oster/uicomponents/resources/EditableTablePanel"); // NOI18N
    btRemoveObject.setToolTipText(bundle1.getString("-")); // NOI18N
    ...
    gridBagConstraints.gridx = 2;
    gridBagConstraints.gridy = 13;
    jPanel1.add(btRemoveObject, gridBagConstraints);

    btAddObject.setIcon(PlatformIcon.get(PlatformIcon.ADD_FILE));
    btAddObject.setToolTipText(bundle1.getString("+")); // NOI18N
    ...
    gridBagConstraints.gridy = 13;
    gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
    jPanel1.add(btAddObject, gridBagConstraints);
    ...
    jmPreferences.setText(bundle.getString("PREFERENCES")); // NOI18N
    ...
    layout.setHorizontalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        .addContainerGap()
        .addComponent(jSplitPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1624, Short.MAX_VALUE)
        .addContainerGap())
      .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(layout.createSequentialGroup()
          .addGap(1648, 1648, 1648)
          .addComponent(warningPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    layout.setVerticalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        .addContainerGap()
        .addComponent(jSplitPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1189, Short.MAX_VALUE)
        .addContainerGap())
      .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        .addGroup(layout.createSequentialGroup()
